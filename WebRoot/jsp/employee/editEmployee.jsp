...
<td>性别：</td>
<td><s:radio name="sex" list="{'male', 'female'}" value="%{model.sex}"/></td>
</tr>
<tr>
<td>user name:</td>
...
<tr>
<td>所属部门：</td>
<td><s:select name="department.did" list="list" value="%{model.department.did}" listKey="did" listValue="dname" headerKey="" headerValue="--select department--" /></td>
<td>编号：</td>
